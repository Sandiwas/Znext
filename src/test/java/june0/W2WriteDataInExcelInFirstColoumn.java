...
public class W2WriteDataInExcelInFirstColoumn {
	public static void main(String[] args) throws IOException {
		FileOutputStream fo = new FileOutputStream(".\\testData\\june3.xlsx");
